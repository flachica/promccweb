 ...
 */
class Accountmod extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('idtienda', 'numerical', 'integerOnly'=>true),
			array('email, password', 'length', 'max'=>128),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, email, password, idtienda', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'tiendas' => array(self::HAS_MANY, 'Tienda', 'idaccount'),
	 ...
	 * @return Accountmod the static model class
	 */
