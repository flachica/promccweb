<?php 
  echo TbHtml::alert(TbHtml::ALERT_COLOR_WARNING, 'Ojo, aquí solo debe de modificar los roles de usuario. Las siguientes opciones son para administrar la plataforma de forma interna. Modifique solo si sabe lo que hace.');
